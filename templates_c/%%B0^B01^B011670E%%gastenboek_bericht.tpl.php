<?php /* Smarty version 2.6.26, created on 2010-08-12 13:32:10
         compiled from gastenboek_bericht.tpl */ ?>
<?php 
...
<div class="gb_berichtkolom">
	...
	<form action="gastenboek.php?act=toevoegen" method="post">
		<div class="gb_formulier">
			...
			<input type="text" name="gb_naam" id="gb_naam" <?php if($_COOKIE[klant][$kl_id][loggedin] == 'yes') echo ' class="alleen_lezen" readonly="readonly"'; ?> value="<?php echo $naam; ?>"/>
			<label for="gb_email">E-mail adres <span></span></label>
			<input type="text" name="gb_email" id="gb_email" <?php if($_COOKIE[klant][$kl_id][loggedin] == 'yes') echo ' class="alleen_lezen" readonly="readonly"'; ?> value="<?php echo $email; ?>"/>
