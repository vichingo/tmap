<?php /* Smarty version 2.6.26, created on 2010-08-13 02:34:21
         compiled from kd_details_gebruiker.tpl */ ?>
<?php 
...
<div id="kd_details_kolom">
	<form name="kd_update" method="post" action="logic/update.php?tabel=gebruiker">
		<div class="kd_data">
			<div class="kd_data_formulier">
				...
				<div class="kd_kolom sluit-rechts-5">
					...
					<div class="kd_row">
						...
						<input type="checkbox" name="promotie" id="promotie" value="ja" <?php 
						if($_COOKIE['klant'][$kl_id]['promotie'] == 'yes'){
			...
			<div class="kd_knoppen">
				<div class="kd_knoppen_balk">
					<button type="submit" name="klant_wijzig" id="klant_wijzig">Wijzig gegevens</button>
				</div>
			</div>
			<div class="kd_errors">
