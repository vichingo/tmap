...
<title>Beheer de gerecht opties</title>
<?php
include 'header.inc';
?>
<script language="javascript" type="text/javascript" src="script/tmap_beheer_gerecht_opties.js"></script>
<style type="text/css">
label,input {
	display: block;
}
...
$go_lijst 		= $go->lijst;
$go_kol 		= $go->aantalKolommen;
$go_rij 		= $go->aantalRijen;
$go_kol_nam 	= $go->kolomNamen;
...
<body>
	...
	<table id="lijst">
		<thead>
			<tr>
				<th colspan="<?php echo $go_kol+1;?>">Gerecht opties</th>
			</tr>
			<tr>
		...
		<tfoot>
			<tr>
				<td colspan="<?php echo $go_kol+1;?>">Aantal bestanddelen: <?php echo $go_rij;?></td>
			</tr>
		</tfoot>
		<tbody id="itemLijst">
		<?php
	...
	<table id="knoppen">
		...
		<tbody>
			<tr>
				<td>
				<button value="go" id="verwijder">Verwijder</button>
				<button value="go" id="maak">Voeg toe</button>
				<button value="go" id="wijzig">Wijzig</button>
				</td>
			</tr>
		</tbody>
	</table>
	...
	?>
	<div id="add-form" class="hidden" title="Voeg een optie toe">
	...
	<div id="edit-form" class="hidden" title="Wijzig opties">
