...
<table>
	<tbody>
		...
		<tr>
			<td>
				<h2 class="menu_header">{php}echo $menu->naam;{/php}</h2><h4>(Klik op een rij om de opties te tonen)</h4>
			</td>
		</tr>
		{php}
		...
		<tr class="gerecht_rij">
			<td class="gerecht_lijn" id="rij_{php}echo $gerecht->id;{/php}">
				<img src="images/content/{php}echo $gerecht->image;{/php}" alt="{php}echo $gerecht->naam;{/php}"/>
				<div class="gerecht_data">
					<p class="gerecht_code">
						{php}echo $gerecht->code;{/php}
					</p>
					<p class="gerecht_naam">
						{php}echo $gerecht->naam;{/php}
					</p>
					<p class="gerecht_omschrijving">
						{php}echo $gerecht->omschrijving;{/php}
					</p>
					...
					<p class="gerecht_basisprijs">
						&#8364; <span class="gerecht_prijs_{php}echo $gerecht->id;{/php}">{php}echo $basisprijs_totaal;{/php}</span>
					</p>
				</div>
			</td>
			<td class="hidden">
				<input type="radio" class="gerecht_keuze" name="gerecht_id[]" value="{php}echo $gerecht->id;{/php}" />
			</td>
		</tr>
		{php}
					}
