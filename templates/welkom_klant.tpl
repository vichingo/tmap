...
<div id="welkomkolom">
	...
	{/php}
	<h3>Uw laaste bestelling is {php} echo tijdTussen($laatste_bestelling_lijst[0]->besteltijd, time()){/php}</h3>
	<div id="laatse_bestelling">
		<div id="opsomming">
			<div class="laatse_bestelling_nummer">
				<p>BestelNummer: <span>{php} echo $laatste_bestelling_lijst[0]->bestelling_nummer;{/php}</span></p>
			</div>
			<div class="laatse_bestelling_tijd">
				<p>Besteld op: <span>{php} echo date('d-m-Y', $laatste_bestelling_lijst[0]->besteltijd) . ' om ' . date('H:i', $laatste_bestelling_lijst[0]->besteltijd) {/php}</span></p>
			</div>
			<div class="laatse_bestelling_leverwijze">
				<p>U heeft de bestelling laten: <span>{php} echo ucfirst($laatste_bestelling_lijst[0]->leverwijze_naam);{/php}</span></p>
			</div>
			<div class="laatse_bestelling_lijnen">
				<p>Aantal gerechten: <span>{php}echo $aantal_lijnen;{/php}</span></p>
			</div>
			<div class="laatse_bestelling_totaal_prijs">
				<p>Totaal te betalen: <span>&#8364; {php} echo $laatste_bestelling_lijst[0]->totaal_prijs;{/php}</span></p>
			</div>
		</div>
		...
		<div class="laatse_bestelling_lijn">
			<div class="laatse_bestelling_lijn_aantal">{php} echo $lijn->lijn_aantal;{/php} x</div>
			<div class="laatse_bestelling_lijn_naam">{php} echo $lijn->lijn_naam;{/php}</div>
			<div class="laatse_bestelling_lijn_opties">
				...
				//start foreach
				{/php}
					<li>{php }echo $optie->optie_naam . ': ' .  $optie->variant_naam{/php}</li>
				{php}
				}
				// end foreach
				{/php}
			...
			<div class="laatse_bestelling_lijn_prijs">&#8364; {php} echo $lijn->lijn_prijs;{/php}</div>
		</div>
		{php}
		}
		// end foreach
